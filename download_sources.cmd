...
curl -LsSO --output-dir "%bDir%\src\qtbase" "%qt_patch_url%/CVE-2025-4211-qtbase-5.15.diff"
curl -LsSO --output-dir "%bDir%\src\qtbase" "%qt_patch_url%/CVE-2025-5455-qtbase-5.15.patch"
:verMin19
